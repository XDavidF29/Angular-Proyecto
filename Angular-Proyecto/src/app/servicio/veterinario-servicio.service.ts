...
export class VeterinarioServicioService {
  ...
  //Accede a la información del  veterinario login
  loginVeterinario(cedula: number): Observable<Veterinario> {
    return this.http.get<Veterinario>(`http://localhost:8090/veterinario/login-veterinario?cedula=${cedula}`);
  }
